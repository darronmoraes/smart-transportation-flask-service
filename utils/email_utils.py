...
def send_otp_email(
    ...
    email_subject = "Your OTP is %s" % otp
    email_body_text = "Your requested OTP is %s" % otp
...
def send_email_from_template(
    email_template, email_body_text, to, subject, **kwargs
):
    ...
    return send_email(to, subject, email_body_text, email_body)
...
def send_email(recipient, subject, body_text, body_html):
    ...
    msg["Subject"] = subject
    msg["From"] = email.utils.formataddr(("ktcl", "darrontaciomoraes14@gmail.com"))
    msg["To"] = recipient
